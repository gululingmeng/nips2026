...
# ============================================================
# TD3-style actor-critic for discrete CartPole actions
# ============================================================
...
def main():
    ...
    env_train = CartPoleSafetyEnv(env_name="CartPole-v1", max_steps=500, seed=12)
    ...
    # Optionally add noise during TD3 data collection.
