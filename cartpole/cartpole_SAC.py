...
# ============================================================
# SAC actor-critic for discrete CartPole actions
# ============================================================
...
def rollout_episode(env,
    ...
    while not done:
        a, action_value, noisy_state = agent.select_action(
            s,
        ...
        if store_to_replay:
            agent.replay.add(s, action_value, float(r_aug), ns, float(done))
...
def main():
    ...
    # Optionally add noise during SAC data collection.
