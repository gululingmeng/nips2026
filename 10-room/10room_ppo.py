...
# ============================================================
# PPO actor-critic for discrete 10-room actions
# ============================================================
...
def train_ppo_baseline(env_train: TenRoomBenchmarkEnv,
    ...
    for k in range(train_cfg.max_outer_iters):
        ...
        if (k % train_cfg.test_every) == 0 or (k == train_cfg.max_outer_iters - 1):
            ...
            if eval_stats["phi_rate"] >= train_cfg.success_threshold:
                final_result = {
                    "outer_iter": k,
                    "eval": eval_stats,
...
def main() -> None:
    ...
    history, res = train_ppo_baseline(
        env_train=env_train,
        env_eval=env_eval,
        agent=agent,
        train_cfg=train_cfg,
